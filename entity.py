    ...
    def move_astar(self, target, entities, game_map):
        ...
        for entity in entities:
            if entity.blocks and entity != self and entity != target:
                # Set the title as a wall so it must be navigated around
        ...
        # The path size matters if you don't want the monster to use alternative longer paths (for example through other rooms) if for example the player is in a corridor
        ...
        if not libtcod.path_is_empty(my_path) and libtcod.path_size(my_path) < 25:
            ...
            # Delete the path for free memory
